(define (problem mekorama26)   ;; this is a skeleton to a problem file for the mekorama26 puzzle
   ...
   (:objects t1 t2 t3 t4 t5 t6 t7 
             x1 x2 x3 x4 x5 x6
             y1 y2 y3 y4 y5 y6)   ;; all objects
             
   (:init (pos x1) (pos x2) (pos x3) (pos x4) (pos x5) (pos x6)     ;; positions and their relations    
	      ...
	      (hor2 t1) (at t1 x1 y4)   ;; where are the tiles?
	      (ver3 t2) (at t2 x3 y4)
          (ver3 t3) (at t3 x4 y5)
          (hor2 t4) (at t4 x4 y3)
          (ver3 t5) (at t5 x6 y3)
	      ...
	      (blank x1 y6) ;; which slots are empty?
	      (blank x1 y5) 
	      (blank x1 y3) 
	      (blank x1 y2) 
	      (blank x1 y1)
